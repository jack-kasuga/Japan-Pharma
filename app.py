...
st.markdown("""
    ...
    .stButton > button {
        ...
        height: 2.6em !important; /* スマホでも押しやすいよう少しだけ高く */
        padding: 0px 2px !important;
    ...
    /* 📱📱 スマホ用専用レイアウト（画面幅768px以下の場合に自動適用） 📱📱 */
    @media screen and (max-width: 768px) {
        .block-container {
            padding-top: 3.5rem !important; /* スマホは上部余白を少し詰める */
            padding-left: 0.5rem !important;
            padding-right: 0.5rem !important;
        }
        .main-title {
            font-size: 1.2rem !important; /* スマホではタイトルを小さくして見切れ防止 */
            margin-bottom: 15px !important;
        }
        [data-testid="column"] {
            /* スマホでは1行に約3〜4個のボタンを並べて折り返す */
            flex: 1 1 22% !important;
            min-width: 22% !important;
            margin-bottom: 6px !important; /* 折り返した時の縦の隙間 */
        }
        .stButton > button {
            font-size: 0.8rem !important; /* スマホでは逆に文字を少し大きくしてタップしやすく */
        }
    }
    </style>
